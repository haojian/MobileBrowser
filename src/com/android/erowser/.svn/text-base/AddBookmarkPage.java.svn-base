...
public class AddBookmarkPage extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.erowser_add_bookmark);
    ...
    private boolean updateBookmarksDB(String title, String url, Bitmap thumbnail, String touchIconUrl) {
        try {
            ...
            if (touchIconUrl != null) {
                final Cursor c =
                        ErowserBookmarksAdapter.queryBookmarksForUrl(cr, null, url, true);
    ...
    boolean save() {
        ...
        String unfilteredUrl = 
                ErowserActivity.fixUrl(mAddress.getText().toString());
