...
public class CombinedBookmarkHistoryActivity extends TabActivity
    ...
    static class IconListenerSet implements IconListener {
        ...
        // ErowserBookmarksAdapter. They should probably be unified.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // newest icons.
        ErowserP.requestAllIcons(getContentResolver(), null, sIconListenerSet);

        Intent bookmarksIntent = new Intent(this, ErowserBookmarksPage.class);
        bookmarksIntent.putExtras(extras);
        createTab(bookmarksIntent, R.string.tab_bookmarks,
                R.drawable.erowser_bookmark_tab, BOOKMARKS_TAB);

        Intent visitedIntent = new Intent(this, ErowserBookmarksPage.class);
        ...
        createTab(visitedIntent, R.string.tab_most_visited,
                R.drawable.erowser_visited_tab, VISITED_TAB);

        Intent historyIntent = new Intent(this, ErowserHistoryPage.class);
        historyIntent.putExtras(extras);
        createTab(historyIntent, R.string.tab_history,
                R.drawable.erowser_history_tab, HISTORY_TAB);
