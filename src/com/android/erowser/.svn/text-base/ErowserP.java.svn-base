...
public class ErowserP {
    private static final String LOGTAG = "erowser";
    public static final Uri BOOKMARKS_URI =
        Uri.parse("content://erowser/bookmarks");

    /**
     * The inline scheme to show embedded content in a erowser.
     * @hide
     */
    public static final Uri INLINE_URI = Uri.parse("inline:");

    /**
     * The name of extra data when starting Erowser with ACTION_VIEW or
     * ACTION_SEARCH intent.
     * <p>
     * The value should be an integer between 0 and 1000. If not set or set to
     * 0, the Erowser will use default. If set to 100, the Erowser will start
     * with 100%.
     */
    public static final String INITIAL_ZOOM_LEVEL = "erowser.initialZoomLevel";

    /**
     * The name of the extra data when starting the Erowser from another
     * application.
     * <p>
     * The value is a unique identification string that will be used to
     * indentify the calling application. The Erowser will attempt to reuse the
     * same window each time the application launches the Erowser with the same
     * identifier.
     */
    public static final String EXTRA_APPLICATION_ID =
        "com.android.erowser.application_id";

    /**
     * The content to be rendered when url's scheme is inline.
     * @hide
     */
    public static final String EXTRA_INLINE_CONTENT ="com.android.erowser.inline.content";

    /**
     * The encoding of the inlined content for inline scheme.
     * @hide
     */
    public static final String EXTRA_INLINE_ENCODING ="com.android.erowser.inline.encoding";

    /**
     * The url used when the inline content is falied to render.
     * @hide
     */
    public static final String EXTRA_INLINE_FAILURL ="com.android.erowser.inline.failurl";

    /**
     * The name of the extra data in the VIEW intent. The data is in boolean.
     * <p>
     * If the Erowser is handling the intent and the setting for
     * USE_LOCATION_FOR_SERVICES is allow, the Erowser will send the location in
     * the POST data if this extra data is presented and it is true.
     * <p>
     * pending api approval
     * @hide
     */
    public static final String EXTRA_APPEND_LOCATION = "com.android.erowser.append_location";
     ...
     * @hide
     */
    public static final String EXTRA_POST_DATA = "com.android.erowser.post_data";
    ...
    public static final Uri SEARCHES_URI =
        Uri.parse("content://erowser/searches");
    ...
    public static final void saveBookmark(Context c, 
                                          String title, 
                                          String url) {
        Intent i = new Intent(Intent.ACTION_INSERT, ErowserP.BOOKMARKS_URI);
