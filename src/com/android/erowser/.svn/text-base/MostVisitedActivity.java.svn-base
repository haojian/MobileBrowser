    ...
    private class MyAdapter implements ListAdapter {
        ...
        MyAdapter() {
            ...
            String[] projection = new String[] {
                    ErowserP.BookmarkColumns.URL,
                    ErowserP.BookmarkColumns.TITLE,
                    ErowserP.BookmarkColumns.BOOKMARK,
                    ErowserP.BookmarkColumns.FAVICON };
            String whereClause = ErowserP.BookmarkColumns.VISITS + " != 0";
            String orderBy = ErowserP.BookmarkColumns.VISITS + " DESC";
            mCursor = managedQuery(ErowserP.BOOKMARKS_URI, projection,
