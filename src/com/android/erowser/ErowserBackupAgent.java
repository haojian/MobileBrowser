...
/**
 * Settings backup agent for the Android erowser.  Currently the only thing
 ...
 * @hide
 */
public class ErowserBackupAgent extends BackupAgent {
    static final String TAG = "ErowserBackupAgent";
            ...
            while (data.readNextHeader()) {
                if (BOOKMARK_KEY.equals(data.getKey())) {
                    ...
                    try {
                        ...
                        // them to the erowser's database
                        ...
                        for (int i = 0; i < N; i++) {
                            ...
                            Cursor cursor = getContentResolver().query(ErowserP.BOOKMARKS_URI,
