...
/**
 *  View showing the user's current erowser downloads
 */
public class ErowserDownloadPage extends Activity 
        implements View.OnCreateContextMenuListener, OnItemClickListener {
    
    private ListView                mListView;
    private Cursor                  mDownloadCursor;
    private ErowserDownloadAdapter  mDownloadAdapter;
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.erowser_downloads_page);
        ...
        if (mDownloadCursor != null) {
            ...
            mDownloadAdapter = new ErowserDownloadAdapter(this, 
                    R.layout.erowser_download_item, mDownloadCursor);
        ...
        if (!mDownloadCursor.isAfterLast()) {
            ...
            if (status == Downloads.STATUS_FILE_ERROR) {
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setMessage(ErowserDownloadAdapter.getErrorText(status))
                        .setPositiveButton(R.string.ok, null)
                        .show();
            }
        }
